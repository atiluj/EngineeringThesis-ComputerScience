...
Ale właściwie, dlaczego tak się stało? W przypadku złożonych struktur danych operator przypisania nie kopiuje obiektu, tylko adres pamięci. To oznacza, że *lista1* i *lista2* wskazują na ten sam adres pamięci, a tym samym w pamięci istnieje tylko jedna instacja tej listy. <br/> <br/>
