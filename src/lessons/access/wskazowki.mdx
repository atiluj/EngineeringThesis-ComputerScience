...
Przy imporcie danych &#60 &#60 data &#62 &#62 może wyświetlać się w sensowny sposób, sprawiając wrażenie, że formatowanie jest prawidłowe. Zawsze jednak upewnij się, że faktycznie tak jest! Błąd popełniony w tym miejscu będzie fatalny w skutkach.
...
<img src={new URL('https://i.imgur.com/dggEAGX.png', import.meta.url)} alt="xyz" className={`big_img`} />
