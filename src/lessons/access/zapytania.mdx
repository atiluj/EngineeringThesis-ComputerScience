...
<img src={new URL('../../img/soki_i_studenci.png', import.meta.url)} alt="studenci pijacy soki w barze" />
...
Pamiętajmy jednak, że pokrywamy tutaj tylko podstawy. Powinny one wsytaczyć na część pisemną matury z informatyki i zadania z SQL-a. które możemy na nich znaleźć. 
...
<img src={new URL('../../img/soki_bary_diagram.png', import.meta.url)} alt="studenci pijacy soki w barze" />
