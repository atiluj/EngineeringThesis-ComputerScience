...
#### Szablon składni
<span className="color_marked_text">SELECT</span> co <span className="color_marked_text">[F.AGREGUJĄCE] <br/>
FROM </span> tabele <br/>
<span className="color_marked_text"> WHERE </span> warunki <br/>
