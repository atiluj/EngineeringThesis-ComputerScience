...
Lub stworzyć nową kwerendę, która policzy ilość rekordów w poprzedniej. (Wtedy warto zmienić nazwę "zad 5" na "zad 5 pom2", a dopiero ostateczny wynik nazwać "zad 5". Oczywiście możemy też przyjąć inną konwencję nazewniczą. Tak długo, jak jest ona czytelna i przejrzysta, wszystko powinno być w porządku.)
