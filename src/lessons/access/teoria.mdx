...
<img src={new URL('../../img/access/klucz_obcy.png', import.meta.url)} alt="xyz" className={`small_img`} />
...
<img src={new URL('../../img/access/1do1.png', import.meta.url)} alt="xyz" className={`small_img`} />
...
<img src={new URL('../../img/access/1don.png', import.meta.url)} alt="xyz" className={`small_img`} />
...
<img src={new URL('../../img/access/ndon.png', import.meta.url)} alt="xyz" className={`small_img`} />
