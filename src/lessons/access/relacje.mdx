...
<img src={new URL('https://i.imgur.com/TRZDyID.png', import.meta.url)} alt="xyz" className="medium-img" />
...
<img src={new URL('https://i.imgur.com/ReqeQCU.png', import.meta.url)} alt="xyz" className="medium-img" />
