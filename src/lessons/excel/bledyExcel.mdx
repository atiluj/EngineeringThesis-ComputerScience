...
## #N/D!
N/D to skrót od niedostępne. Błąd ten pojawia się zazwyczaj, gdy funkcja nie jest w stanie znaleźć żądanej wartości, np. funckcja x.wyszukaj (jeśli nie podamy wartości w wypadku braku znalezienia dopasowania).
<img src={new URL('https://i.imgur.com/wEzngqe.png)', import.meta.url)} alt="xyz" className={`small_img`} />

## #NAZWA?
Pojawia się, gdy Excel nie zna nazwy funkcji, którą chemy użyć. Jest to jeden z najczęściej pojawiających się błędów. Oznacza on zazwyczaj, że zrobiliśmy literówkę lub użyliśmy polskiej nazwy funkcji wbudowanej w angielskojęzycznej wersji programu (bądź na odwrót angielskiej nazwy w polskim Excelu).
...
## #ADR!
Pojawia się, gdy odwołujemy się do nieitniejącej komórki lub arkusza, czyli w skrócie popełnimy błąd w adresie, do którego chcemy się odwołać.
...
https://support.microsoft.com/pl-pl/excel
https://kemsoft.pl/artykul-wartosci-bledow-w-excelu
https://expose.pl/bledy-w-excelu/
