...
Wskaż, czy dane wyrażenie nawiasowe jest poprawne. Wpisz <b>Tak</b>, jeśli wyrażenie jest
poprawne lub <b>Nie</b> – jeśli nie jest poprawne.<br/> 

![](https://i.imgur.com/3ZEgl8g.png)
