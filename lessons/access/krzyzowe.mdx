...
<img src={new URL('https://i.imgur.com/1HpsoAv.png', import.meta.url)} alt="xyz" className="small-img" />
...
<img src={new URL('https://i.imgur.com/5rcLiT6.png', import.meta.url)} alt="xyz" className="medium-img" />

### 3. Wybieramy nagłowki wierszy.
W zestawieniu chcemy mieć informację o ilości komputerów, które uległy awarii, w zależności od sekcji i miesiąca. Zatem to właśnie pola `Sekcja` i `Miesiac` będą naszymi nagłówkami. W zasadzie nie ma różnicy, które z nich ustawimy jako nagłowek wierszy, a który kolumn. Weźmy więc `Sekcję` jako nagłówek wierszy.
...
<img src={new URL('https://i.imgur.com/TXYEANU.png', import.meta.url)} alt="xyz" className="medium-img" />

### 4. Wybieramy nagłowki kolumn.
<img src={new URL('https://i.imgur.com/K4sOiss.png', import.meta.url)} alt="xyz" className="medium-img" />
...
<img src={new URL('https://i.imgur.com/IBIzvXF.png', import.meta.url)} alt="xyz" className="medium-img" />
