...
### 2. Wybieramy tabelę (lub kilka tabel), których potrzebujemy. Przeciągamy je, a następnie wybieramy potrzebne nam pola, aby dodac je do zapytania. 
...
Będziemy potrzebować pola `Pojemność_dysku`, które znajduje się tabeli `Komputery`.
...
Widzimy, że nie jest to odpowiedź jakiej oczekujemy, mamy bowiem po prostu spis pojemności dysków wszytstkich komputerów. 
