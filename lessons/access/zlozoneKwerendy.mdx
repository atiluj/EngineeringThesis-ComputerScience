...
<img src={new URL('https://i.imgur.com/5LHeQWa.png', import.meta.url)} alt="xyz" className="medium-img" />
...
<img src={new URL('https://i.imgur.com/qSbCtJf.png', import.meta.url)} alt="xyz" className="medium-img" />
...
<img src={new URL('https://i.imgur.com/3ip6hpW.png', import.meta.url)} alt="xyz" className="medium-img" />
...
<img src={new URL('https://i.imgur.com/GvD4VNL.png', import.meta.url)} alt="xyz" className="medium-img" />
Mamy już wszystkie naprawy komputerów z sekcji "A", które polegały na wymianie podzespołów.
<img src={new URL('https://i.imgur.com/kkGJC99.png', import.meta.url)} alt="xyz" className="medium-img" />
